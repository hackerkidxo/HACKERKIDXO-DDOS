...
How To Install HACKERKIDXO-DDOS In Termux
...
$ git clone https://github.com/hackerkidxo/HACKERKIDXO-DDOS.git

$ cd HACKERKIDXO-DDOS

$ chmod +x HACKERKIDXO-DDOS.py

$ python2 HACKERKIDXO-DDOS.py
